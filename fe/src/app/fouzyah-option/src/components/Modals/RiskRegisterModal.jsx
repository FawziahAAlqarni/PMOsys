...
const RiskRegisterModal = ({ risks, onClose, onUpdate }) => {
  ...
  const impactMap = { "الاستراتيجية": ["الحوكمة", "المستهدفات"], "المالية": ["التكاليف", "السيولة"], "التشغيلية": ["الإجراءات", "الموارد"], "التقنية": ["الأنظمة", "البيانات"], "السمعة": ["المصداقية", "العملاء"] };
