...
const StatisticsPage = ({ onNavigate }) => {
  ...
  const gateDistribution = [
    { gate: 'البوابة 1', count: projects.filter(p => p.stage === 1).length, color: 'bg-blue-500' },
    { gate: 'البوابة 2', count: projects.filter(p => p.stage === 2).length, color: 'bg-indigo-500' },
    { gate: 'البوابة 3', count: projects.filter(p => p.stage === 3).length, color: 'bg-purple-500' },
    { gate: 'البوابة 4', count: projects.filter(p => p.stage === 4).length, color: 'bg-pink-500' },
